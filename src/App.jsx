...
import { TEST_CONFIG, QUESTIONS } from './data/questions';
import { TEST_INFO } from './data/testInfo';
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                        <div>
                            ...
                            >
                                {profile.name} • {formatDate(profile.dob)} • {calculateAge(profile.dob)}y • {profile.gender}
